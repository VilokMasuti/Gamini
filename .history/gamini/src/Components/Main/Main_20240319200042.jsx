        ...
        {!showresult ? (
          <>
            <div className="greet mt-[50px] mb-[50px] ml-0 mr-0  text-[56px] text-[#c4c7c5] font-[500] p-20px">
              <p className=" ">
                <span className=" max-md:text-[22px] max-md:ml-[15%] max-md:mt-[25%] bg-gradient-to-r from-blue-500 to-red-500 bg-clip-text text-transparent">
                  HELLO,DEV.
                </span>
              </p>
              <p className="max-md:text-[22px]  max-md:ml-[6%] ">
