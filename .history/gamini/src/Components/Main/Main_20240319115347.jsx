    ...
    <div className=" main flex-1 max-h-[100vh] pb-[15vh] relative">
      ...
      <div className=" max-w-[900px] m-auto">
        <div className="greet mt-[50px] mb-[50px] ml-0 mr-0  text-[56px] text-[#c4c7c5] font-[500] p-20px">
          <p className="">
            <span className=" max-md:text-[22px] ml-20 bg-gradient-to-r from-blue-500 to-red-500 bg-clip-text text-transparent">
              HELLO,DEV.
            </span>
          </p>
          <p className="max-md:text-[20px] ml-6">How Can I Help You Tody? </p>
        </div>
