            ...
            <div className=" max-md:flex-col max-md:flex-1 flex    flex-row  gap-[15px]  p-20px]">
              {card.map((item, index) => (
                <>
                  <div
                    key={index}
                    className="  hover:bg-[#dfe4ea] hover:border-red-600 duration-1000  max-md:h-[150px] max-md:w-[200px] h-[240px] w-[250px] p-[15px] bg-[#f0f4f9]  rounded-[10px] relative cursor-pointer"
                  >
