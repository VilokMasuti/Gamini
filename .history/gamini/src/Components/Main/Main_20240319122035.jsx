...
const Main = () => {
  return (
    <div className=" main flex-1 max-h-[100vh] pb-[15vh] relative">
      ...
      <div className=" bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] m-auto">
        <div className=" flex items-center  justify-between gap-[20px] rounded-[50px] bg-[#f0f4f9] pt-[10px] pb-[10x] pl-[20px]pr-[20px] ">
          <input
            className="  flex items-center justify-between gap-[20px] bg-[#f0f4f9]"
            type=" text"
            placeholder="Enter a Propmt Here"
          />

          <img src={assets.gallery_icon} alt="" width={20} height={40} />
          <img src={assets.menu_icon} alt="" width={20} height={40} />
