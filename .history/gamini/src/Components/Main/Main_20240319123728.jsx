    ...
    <div className=" main flex-1 max-h-[100vh] pb-[15vh] relative">
      ...
      <div className=" max-w-[900px] m-auto">
        ...
        <div className=" bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] pt-0 pb-0  ">
          <div className=" flex items-center  justify-between gap-[10px] rounded-[50px]  bg-[#f0f4f9] p-5 mb-[-3%]   ">
            {" "}
            <input
          ...
          <p className=" text-[13px] mt-[25px] mr-[15px] ml-[15px] mb-[15px]    text-center font[300]">
