      ...
      <div className=" max-w-[900px] m-auto">
        {!showresult ? (
          <>
            ...
            <div className="max-md:flex-col flex flex-row flex-wrap justify-center gap-4 p-4 md:p-20">
              {card.map((item, index) => (
                <div
                  key={index}
                  className="hover:bg-gray-200 duration-1000 w-full md:w-[250px] p-4 bg-gray-100 rounded-lg relative cursor-pointer"
                >
                  <p className="text-gray-700 text-lg">{item.p}</p>
                  <img
          ...
          <div className="result pt-0 pb-0 pl-[5%] pr-[5%] max-h-[70vh] overflow-y-scroll scrollbar-hidden">
            ...
            <div className=" resul-tdata flex items-center gap-[20px]">
              ...
              {loading ? (
                ...
                <p
                  className="   font-outfit   text-[17px] font-[400]   "
        ...
        <div className=" max-md:mt-3 bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] pt-0 pb-0  ">
