  ...
  return (
    <div className=" main flex-1 max-md:flex-col  max-h-[100vh] pb-[15vh] relative">
      ...
      <div className=" max-w-[900px] m-auto">
            ...
            <div className="  max-md:flex-1 max-md:flex-col  flex    flex-row  gap-[15px] max-md:gap-4  max-md:pt-[-2%] max-md:pl-14 p-20px]">
              {card.map((item, index) => (
                <>
                  <div
                    key={index}
                    className="  hover:bg-[#dfe4ea] hover:border-red-600 duration-1000 max-md:h-[200px]   h-[240px] w-[250px] p-[15px] bg-[#f0f4f9]  rounded-[10px] relative cursor-pointer"
                  >
        ...
        <div className="  bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] pt-0 pb-0 max-md:w-[40%]  max-md:ml-[2%]   max-md:bottom-[-1000px] ">
