  ...
  return (
    <div className=" main flex-1 max-md:flex-col  max-h-[100vh] pb-[15vh] relative">
      ...
      <div className=" max-w-[900px] m-auto">
        ...
        <div className="  bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] pt-0 pb-0 max-md:w-[40%]  max-md:ml-[2%]   max-md:bottom-[-500px] ">
          ...
          <p className="  max-md:text-[10px] max-md:mb-[50px] max-md:text-balance  text-[13px] mt-[26px] mr-[15px] ml-[15px] mb-[15px]    text-center font[300]">
