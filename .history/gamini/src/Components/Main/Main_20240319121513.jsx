...
const Main = () => {
  return (
    <div className=" main flex-1 max-h-[100vh] pb-[15vh] relative">
      ...
      <div className=" bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] ">
        className=" mt-6 flex items-center justify-between gap-[20px]
        bg-[#f0f4f9]" type=" text" placeholder="Enter a Propmt Here" />
        <div>
