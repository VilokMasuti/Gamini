        ...
        {!showresult ? (
          ...
          <div className="result">
            <div className="result-tilte">
              <img src={assets.user_icon} width={30} height={30} />
              <p>{recentPrompt} </p>
            </div>
            <div className=" resul-tdata">
              <img src={assets.gemini_icon} width={30} height={30} />
              <p className=" text-4xl text-amber-500"> {resultdate}</p>
            </div>
            sdsasdfafaf
          </div>
        )}
        ...
        <div className=" bottom absolute bottom-0 w-full max-w-[900px] pl-[20px] pr-[20px] pt-0 pb-0  ">
          <div className=" flex items-center  justify-between gap-[10px] rounded-[50px]  bg-[#f0f4f9] p-4 mb-[-3%]   ">
            ...
            <input
              ...
              value={input}
              className="   outline-5  flex items-center justify-between gap-[20px] bg-[#f0f4f9] "
              type=" text"
